...
// --- CUSTOM REAL-TIME SPARKLINE COMPONENT ---
...
const LiveSparkline: React.FC<LiveSparklineProps> = ({ baseValue, volatility, color }) => {
...
// --- CUSTOM REAL-TIME TELEMETRY CASH FLOW GRAPH COMPONENT ---
interface LiveTelemetryGraphProps {
  expectedTotal: number;
  collectedTotal: number;
}

const LiveTelemetryGraph: React.FC<LiveTelemetryGraphProps> = ({ expectedTotal, collectedTotal }) => {
...
export default function App() {
  ...
  // Live Polling State
  const [collectedAmount, setCollectedAmount] = useState<number>(8920000);
  const [outstandingAmount, setOutstandingAmount] = useState<number>(12540000);

  // Carousel State: Sequence Invoice → Quotation → Invoice → Quotation → Invoice → Invoice (6 items)
  ...
  // Autoplay carousel every 4.5 seconds
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-[#043f2e] flex items-center justify-center p-0 sm:p-4 md:p-6 antialiased font-sans">
      <style>{`
        ...
        .font-grenette { font-family: 'Fraunces', serif; }
        .font-graphik { font-family: 'Inter', sans-serif; }
        ...
        .pulsing-dot {
          ...
          border-radius: 50%;
          box-shadow: 0 0 0 0 rgba(4, 63, 46, 0.7);
          animation: pulse 1.5s infinite;
        }
        @keyframes pulse {
          0% { transform: scale(0.95); box-shadow: 0 0 0 0 rgba(4, 63, 46, 0.7); }
          70% { transform: scale(1); box-shadow: 0 0 0 5px rgba(4, 63, 46, 0); }
          100% { transform: scale(0.95); box-shadow: 0 0 0 0 rgba(4, 63, 46, 0); }
        }
      `}</style>
      ...
      <div className="w-full max-w-[430px] h-[100vh] sm:h-[900px] bg-[#eef2e3] relative overflow-hidden sm:rounded-[32px] border-0 sm:border-[8px] border-[#043f2e] flex flex-col justify-between font-graphik">
        ...
        <header className="bg-[#fcfcfc] px-4 py-3.5 flex items-center justify-between z-30 shrink-0 border-b border-[#043f2e]/10">
          <div className="flex items-center space-x-2.5">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 text-[#043f2e]">
                <path
        ...
        <main className="flex-1 overflow-y-auto no-scrollbar px-3.5 py-4 space-y-5 pb-20">
          ...
          {/* =========================================================
              REPLACED SECTION: INFINITE SWIPEABLE NOTIFICATION CAROUSEL
              Sequence: Invoice → Quotation → Invoice → Quotation → Invoice → Invoice
              ========================================================= */}
          <section className="space-y-2">
            <div className="flex justify-between items-baseline px-1">
              ...
              <span className="text-[10px] font-mono text-[#043f2e]/70">
                {currentSlideIndex + 1} / {notificationsList.length}
              </span>
            </div>
            ...
            <div className="bg-[#fcfcfc] rounded-[16px] border border-[#043f2e]/10 divide-y divide-[#043f2e]/10 overflow-hidden">
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <span className="inline-block text-[9px] text-[#000000] bg-[#c8f169] px-2 py-0.5 rounded-[4px] font-medium uppercase tracking-[0.06em] mt-0.5">
                    Active
                  </span>
                </div>
              </div>
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <span className="inline-block text-[9px] text-[#043f2e] bg-[#eef2e3] px-2 py-0.5 rounded-[4px] border border-[#043f2e]/20 font-medium uppercase tracking-[0.06em] mt-0.5">
                    Approved
                  </span>
                </div>
              </div>
          ...
          {/* 4. DEEP FOREST DARK PRODUCT ISLAND WITH LIVE TELEMETRY GRAPH */}
        ...
        {/* FLOATING CHARTREUSE CTA BUTTON */}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1 overflow-y-auto max-h-[360px] no-scrollbar pr-1">
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] bg-[#c8f169] text-[#000000] text-xs font-medium uppercase tracking-[0.06em]"
              >
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] text-[#043f2e] hover:bg-[#fcfcfc] text-xs font-normal uppercase tracking-[0.06em]"
              >
                <FileSpreadsheet className="w-3.5 h-3.5 text-[#043f2e]" />
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] text-[#043f2e] hover:bg-[#fcfcfc] text-xs font-normal uppercase tracking-[0.06em]"
              >
                <ClipboardCheck className="w-3.5 h-3.5 text-[#043f2e]" />
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] text-[#043f2e] hover:bg-[#fcfcfc] text-xs font-normal uppercase tracking-[0.06em]"
              >
                <Truck className="w-3.5 h-3.5 text-[#043f2e]" />
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] text-[#043f2e] hover:bg-[#fcfcfc] text-xs font-normal uppercase tracking-[0.06em]"
              >
                <CreditCard className="w-3.5 h-3.5 text-[#043f2e]" />
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] text-[#043f2e] hover:bg-[#fcfcfc] text-xs font-normal uppercase tracking-[0.06em]"
              >
                <FolderKanban className="w-3.5 h-3.5 text-[#043f2e]" />
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] text-[#043f2e] hover:bg-[#fcfcfc] text-xs font-normal uppercase tracking-[0.06em]"
              >
                <Users className="w-3.5 h-3.5 text-[#043f2e]" />
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] text-[#043f2e] hover:bg-[#fcfcfc] text-xs font-normal uppercase tracking-[0.06em]"
              >
                <ShieldCheck className="w-3.5 h-3.5 text-[#043f2e]" />
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] text-[#043f2e] hover:bg-[#fcfcfc] text-xs font-normal uppercase tracking-[0.06em]"
              >
                <ShieldAlert className="w-3.5 h-3.5 text-[#043f2e]" />
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] text-[#043f2e] hover:bg-[#fcfcfc] text-xs font-normal uppercase tracking-[0.06em]"
              >
                <Package className="w-3.5 h-3.5 text-[#043f2e]" />
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] text-[#043f2e] hover:bg-[#fcfcfc] text-xs font-normal uppercase tracking-[0.06em]"
              >
                <Layers className="w-3.5 h-3.5 text-[#043f2e]" />
              ...
              <button
                ...
                className="w-full flex items-center space-x-2.5 px-3 py-2 rounded-[4px] text-[#043f2e] hover:bg-[#fcfcfc] text-xs font-normal uppercase tracking-[0.06em]"
              >
                <FileQuestion className="w-3.5 h-3.5 text-[#043f2e]" />
        ...
        <nav className="bg-[#fcfcfc] border-t border-[#043f2e]/10 px-2 py-2 flex justify-around items-center z-30 shrink-0">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center text-[#242423] hover:text-[#043f2e] space-y-0.5 transition-transform active:scale-95 w-12"
          >
        ...
        {toastMessage && (
          <div className="absolute bottom-20 left-1/2 -translate-x-1/2 bg-[#043f2e] text-[#fcfcfc] text-xs px-3.5 py-1.5 rounded-[4px] border border-[#c8f169]/50 z-50 flex items-center space-x-1.5 shadow-xl">
            <ArrowRight className="w-3 h-3 text-[#c8f169]" />
            <span className="tracking-[0.04em]">{toastMessage}</span>
          </div>
        )}
      </div>
    </div>
